...
export default class GenreList extends Component {
    ...
    closeAddDialog() { this.setState({ showAddDialog: false }) }
    ...
    updateGenre() {
        this.props.updateGenre(this.state.genreName, this.state.id)
        this.setState({ showUpdateDialog: false })
        this.setState({ genreName: '' })
    }
    insertGenre() {
        this.props.insertGenre(this.state.genreName)
            ...
            <div>
                ...
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.deleteGenre()} variant="primary">Delete</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => this.closeUpdateDialog()}> </Button>
                        <Button onClick={() => this.updateGenre()} variant="primary">Update</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.insertGenre()} variant="primary">Insert</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
