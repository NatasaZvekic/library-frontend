...
export default class DelivererList extends Component {
    ...
    openDialogForUpdate(deliverer){ console.log("del " + deliverer.delivererCompanyName)
    ...
    updateDeliverer(){
        this.props.updateDeliverer(this.state.id, this.state.companyName, this.state.address, this.state.contact)
        this.setState({showUpdateDialog: false})
        this.clearAllFields()
    }
    insertDeliverer(){
        this.props.insertDeliverer(this.state.companyName, this.state.address, this.state.contact)
        this.closeAddDialog()
    }
    onChange(e) {
    ...
    render() {
        return (
            <div>
                <Table responsive style={{ width: '60%', marginLeft: '20%', marginTop: '50px', background: 'white' }}>
                    <thead>
                        <tr>
                            <th style={{ width: '5%' }}>#</th>
                ...
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.deleteDeliverer()} variant="primary">Delete</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => this.closeUpdateDialog()}> Close </Button>
                        <Button onClick={() => this.updateDeliverer()} variant="primary">Update</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => this.closeAddDialog()}> Close  </Button>
                        <Button onClick={() => this.insertDeliverer()} variant="primary">Insert</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
