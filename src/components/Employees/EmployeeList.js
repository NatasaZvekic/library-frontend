...
export default class EmployeeList extends Component {
    ...
    updateEmployee() {
        this.props.updateDeliverer(this.state.password, this.state.id, this.state.name, this.state.lastname, this.state.role, this.state.email, this.state.contact, this.state.ssn)
    ...
    insertEmployee(){ console.log("V " + this.state.ssn)
        this.props.insertEmployee(this.state.password, this.state.name, this.state.lastname, this.state.role, this.state.email, this.state.contact, this.state.ssn)
        this.closeAddDialog()
    }
    ...
    render() {
        return (
            <div>
                <Table responsive style={{ width: '80%', marginLeft: '10%', marginTop: '50px', background: 'white' }}>
                    <thead>
                        <tr>
                            <th style={{ width: '5%' }}>#</th>
                ...
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.deleteEmployee()} variant="primary">Delete</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.updateEmployee()} variant="primary">Update</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.insertEmployee()} variant="primary">Insert</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
