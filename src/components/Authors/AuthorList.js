...
export default class AuthorList extends Component {
    ...
    updateAuthor(){
        const authorForUpdate = {id: this.state.id, name: this.state.name, lastName:this.state.lastname, yearOfBirth: this.state.yearOfBirth}
        this.props.updateAuthor( this.state.id,  this.state.name, this.state.lastname,  this.state.yearOfBirth)
        this.closeUpdateDialog()
    }
    insertAuthor(){ 
        this.props.insertAuthor(this.state.name, this.state.lastname, this.state.yearOfBirth)
        this.closeAddDialog()
    }
    onChange(e) {
            ...
            <div>
                <Table responsive style={{ width: '60%', marginLeft: '20%', marginTop: '50px', background: 'white' }}>
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: '30%' }} >Year of birth </th>
                ...
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.deleteAuthor()} variant="primary">Delete</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Body>
                        ...
                        <input
                            ...
                            name="yearOfBirth"
                            className="inputFiled"
                            defaultValue={this.state.yearOfBirth}
                            onChange={this.onChange.bind(this)}
                        />
                    </Modal.Body>
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => this.closeUpdateDialog()}> Close </Button>
                        <Button onClick={() => this.updateAuthor()} variant="primary">Update</Button>
                    </Modal.Footer>
                </Modal>
                <Modal
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={() => this.insertAuthor()} variant="primary">Insert</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
