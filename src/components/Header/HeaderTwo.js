        ...
        return (
            ...
            <div className="NavbarItems2">
                ...
                <div className={this.state.clicked ? 'nav-menu1 active' : 'nav-menu1'}>
                    ...
                    {/* {localStorage.getItem("role") === "user" ? <NavLink to="/myRentals" className="left">Hello Ivana ivic!</NavLink> : ''} */}

                    { localStorage.getItem("userName") !== null ? <div className="left">Hello {localStorage.getItem("userName")}!</div> : ''}
                </div>
            </div>
        )
    }
